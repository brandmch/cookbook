...
const RECIPES: Recipe[] = [
  ...
  },
  {
    ...
    contributor: "Uncle Steve",
    initials: "US",
    ingredients: ["1 loaf brioche", "6 eggs", "Maple syrup", "Cinnamon sugar"],
  },
  {
    id: 8,
  ...
  },
  {
    ...
    contributor: "Grandma Rose",
    initials: "GR",
    ingredients: ["2¼ cups flour", "1 cup butter", "Royal icing", "Sprinkles"],
  },
  {
    id: 10,
    title: "Aunt Rosa's Lemonade",
    category: "drinks",
    contributor: "Aunt Nancy",
    initials: "AN",
    ingredients: [
  ...
  return (
    <div
      style={{
        ...
        borderRadius: 3,
        boxShadow:
          "0 1px 0 #fff inset, 0 2px 5px rgba(58,44,32,.10), 0 14px 28px -18px rgba(58,44,32,.45)",
        position: "relative",
      }}
    >
      {!compact && (
      ...
      <div style={{ padding: compact ? "10px 12px 12px" : "14px 16px 18px" }}>
        <div
          style={{
            ...
            gap: 8,
            marginBottom: variant === "text" ? 10 : 8,
          }}
        >
          <p
            style={{
      ...
      <Link href="/login">
        <button
          style={{
            ...
            fontWeight: 700,
            cursor: "pointer",
            boxShadow: `0 2px 0 ${C.accentDeep}, 0 6px 16px -6px ${C.accentDeep}`,
          }}
        >
          Start your cookbook
        </button>
    ...
    <div className="paper" style={{ minWidth: 320, background: C.cream1 }}>
      ...
      >
        ...
        <div>
          ...
          >
            Start a private cookbook, invite the people you cook for, and gather
            the recipes that get passed around the table — stories, splatters
            and all — in one warm place.
          </p>
      ...
      <div style={{ background: C.cream2, padding: "60px 56px" }}>
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "flex-start" }}>
          <StepCard
            ...
            tone={C.accent}
            title="Create"
            body="Name your cookbook and claim your family's link in under a minute."
          />
          <StepCard
            n="2"
            Icon={Mail}
            tone={C.secondary}
            title="Invite"
            body="Bring in parents, cousins and that one aunt who never shares her secret."
          />
          <StepCard
            n="3"
            Icon={Users}
            tone={C.honey}
            title="Cook together"
            body="Add recipes with the stories behind them, and cook from any kitchen."
          />
        </div>
      </div>
      ...
      <div style={{ padding: "70px 56px 40px", textAlign: "center" }}>
        ...
        >
          A wall of index cards you can search, filter and scale — each one
          carrying a recipe and the memory attached to it.
        </p>
        {/* Browser mockup */}
        <div
          style={{
            borderRadius: 14,
            overflow: "hidden",
            boxShadow: `0 30px 60px -30px rgba(58,44,32,.5), 0 0 0 1px ${C.cream3}`,
            textAlign: "left",
          }}
        >
          <div
      ...
      <div style={{ padding: "40px 56px 76px" }}>
        ...
        >
          ...
          >
            &ldquo;My grandmother&apos;s handwriting was fading on the index
            cards. Now her apple pie lives where my whole family can find it —
            splatters and all.&rdquo;
          </p>
          <div
            style={{
              display: "flex",
      ...
      >
        ...
        <Link href="/login">
          ...
          >
            ...
            <ArrowRight size={19} color={C.accentDeep} />
          </button>
        </Link>
      </div>
